...
[![GitHub](https://img.shields.io/badge/GitHub-Repository-181717?style=flat-square&logo=github)](https://github.com/Alelourenco/GraficoDonut-PowerBI)
...
1. Baixe o arquivo `DonutWithTotal7C5B4E2A8F9D1E3C.1.1.0.0.pbiviz` da pasta [dist/](./dist/)
...
## Ì∞õ Solu√ß√£o de Problemas

### ‚ùå Visual n√£o carrega
- ‚úÖ Verifique se o arquivo `.pbiviz` foi importado corretamente
- ‚úÖ Certifique-se de que h√° dados nas colunas **Categoria** e **Valores**

### ‚ùå Configura√ß√µes n√£o aparecem
- ‚úÖ Clique no visual primeiro, depois no √≠cone de formata√ß√£o (pincel)
...
### Ì≥¢ Quer um visual personalizado? Entre em contato!
